...
export const MATHS_ACTIVITIES_MERI: MathsActivity[] = [
  ...
  {
    mode: "math" as const,
    label: "Kina Kauntim — 1 + 1",
    q: "Beni has K1 in his hand. Mama gives him K1 more. How many kina does Beni have?",
    tok: "Beni i gat K1 long han bilong em. Mama i givim K1 moa. Hamas kina Beni i gat?",
    visual: "🪙  ➕  🪙  ＝  ❓",
    difficulty: 1,
    addends: [1, 1],
    emojiA: "🪙",
    emojiB: "🪙",
    options: [
      { val: "1", label: "K1", tok: "Wan Kina" },
      { val: "2", label: "K2", tok: "Tu Kina" },
      { val: "3", label: "K3", tok: "Tri Kina" },
    ],
    correct: "2",
  },
  {
  ...
  {
    mode: "math" as const,
    label: "Maket Kina — 3 + 3",
    q: "Beni spends K3 on mangoes and K3 on coconuts at the market. How many kina does he spend altogether?",
    tok: "Beni i baim mango K3 na kokonas K3 long maket. Hamas kina em i baim olgeta?",
    visual: "🪙🪙🪙  ➕  🪙🪙🪙  ＝  ❓",
    difficulty: 2,
    addends: [3, 3],
    emojiA: "🪙",
    emojiB: "🪙",
    options: [
      { val: "5", label: "K5", tok: "Faiv Kina" },
      { val: "7", label: "K7", tok: "Sevn Kina" },
      { val: "6", label: "K6", tok: "Sikis Kina" },
    ],
    correct: "6",
  },
  {
...
export const MATHS_ACTIVITIES_SIONE: MathsActivity[] = [
  ...
  {
    mode: "math" as const,
    label: "Kina Market — 4 + 3",
    q: "Beni's papa earns K4 fixing boats and K3 selling fish. How many kina altogether?",
    tok: "Papa bilong Beni i kisim K4 long wokim bot na K3 long salim pis. Hamas kina olgeta?",
    visual: "🛶 K4  ➕  🐟 K3  ＝  ❓",
    difficulty: 2,
    addends: [4, 3],
    emojiA: "🪙",
