...
import {
  MATHS_STORY_PAGES,
  MATHS_ACTIVITIES_MERI,
  MATHS_ACTIVITIES_SIONE,
  MathsActivity,
} from "../data";
      ...
      >
        ...
        {MAP_PTS.map(([x, y], i) => (
          <g key={i}>
            ...
            />
            {i < step && (
              <circle cx={x} cy={y} r={1.5} fill="#fff" opacity={0.7} />
            )}
          </g>
        ))}
...
// ── Per-slide background images (null = use animated CSS/SVG fallback) ──────
const SLIDE_BG_IMAGES: (string | null)[] = [
  "/LessonBg1.png", // 0 — dawn village
  "/LessonBg2.png", // 1 — morning village
  "/LessonBg3.png", // 2 — walking to market
  "/LessonBg4.png", // 3 — mango tree
  "/LessonBg5.png", // 4 — market stall
  "/LessonBg5.png", // 5 — coconuts
  "/LessonBg6.png", // 6 — mixed fruit
  "/LessonBg7.png", // 7 — celebration
  "/LessonBg8.png", // 8 — fireworks
  "/LessonBg9.png", // 9 — trophy
];

// ── Scene background — CSS sky + SVG props ───────────────────────────────────

function SceneBackground({ slideIndex }: { slideIndex: number }) {
  const bgImage = SLIDE_BG_IMAGES[slideIndex] ?? null;
  const [skyTop, skyBot] =
    SCENE_SKY[Math.min(slideIndex, SCENE_SKY.length - 1)];
  ...
  return (
    <>
      {/* ── Sky layer — photo background OR CSS gradient ── */}
      {bgImage ? (
        <div
          style={{
            position: "absolute",
        ...
        >
          ...
          {isNight && (
            ...
            >
              {[8, 18, 30, 44, 56, 72, 85, 14, 62, 48, 25, 78, 92, 38, 67].map(
                (xPct, i) => (
                  <motion.circle
                    key={i}
                    cx={`${xPct}%`}
          ...
          {isDaytime && (
            <motion.div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, #FFE566 35%, #FFB300 100%)",
          ...
          {slideIndex === 0 && (
            <motion.div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, #FFE033 35%, #ff8c00 100%)",
            ...
            <>
              <motion.div
                style={{
                  ...
                  boxShadow:
                    "36px -18px 0 10px rgba(255,255,255,0.9), -24px -12px 0 5px rgba(255,255,255,0.9), 85px -22px 0 16px rgba(255,255,255,0.9), 130px -12px 0 10px rgba(255,255,255,0.9)",
                  pointerEvents: "none",
                }}
              ...
              <motion.div
                style={{
                  ...
                  boxShadow:
                    "26px -14px 0 7px rgba(255,255,255,0.78), 65px -16px 0 11px rgba(255,255,255,0.78), 95px -8px 0 7px rgba(255,255,255,0.78)",
                  pointerEvents: "none",
                }}
              ...
              <motion.div
                style={{
                  ...
                  boxShadow:
                    "20px -10px 0 5px rgba(255,255,255,0.62), 48px -12px 0 8px rgba(255,255,255,0.62)",
                  pointerEvents: "none",
                }}
      ...
      >
        ...
        {slideIndex === 0 && (
          <>
            ...
            />
            <path
              d="M 230,175 Q 281,136 332,175 Z"
              fill="#2e1a08"
              stroke="#1a0800"
              strokeWidth={2}
            />
        ...
        {slideIndex === 1 && (
          <>
            ...
            />
            <path
              d="M 166,143 Q 247,100 328,143 Z"
              fill="#2a1a10"
              stroke="#1a0800"
              strokeWidth={2.5}
            />
        ...
        {slideIndex === 2 && (
          <>
            ...
            <polygon
              points="155,240 245,240 218,100 182,100"
              fill="#8B5A2B"
              opacity={0.55}
            />
        ...
        {slideIndex === 9 && (
          <>
            <polygon
              points="148,228 252,228 270,240 130,240"
              fill="#FFD93D"
              opacity={0.85}
            />
            <rect
            ...
            >
              {/* Trophy cup */}
              <path
                d="M188,196 Q188,218 200,222 Q212,218 212,196 Z"
                fill="#FFD93D"
                stroke="#1a0800"
                strokeWidth={2}
              />
              ...
              {/* Handles */}
              <path
                d="M188,200 Q182,200 182,208 Q182,216 188,214"
                fill="none"
                stroke="#FFD93D"
                strokeWidth={3}
                strokeLinecap="round"
              />
              <path
                d="M212,200 Q218,200 218,208 Q218,216 212,214"
                fill="none"
                stroke="#FFD93D"
                strokeWidth={3}
                strokeLinecap="round"
...
function AmbientShape({
  ...
  if (type === 1)
    return (
      // Bilum diamond — traditional woven pattern
      <svg width={size} height={size} viewBox="0 0 24 24">
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24">
      <path
        d="M12,2 Q20,8 20,16 Q16,22 12,23 Q8,22 4,16 Q4,8 12,2 Z"
        fill={color}
      />
      <line
        x1={12}
    ...
    >
      ...
      <div
        style={{
          ...
          background:
            "repeating-linear-gradient(90deg,#E63946 0,#E63946 5px,#000 5px,#000 10px,#FFD93D 10px,#FFD93D 15px,#000 15px,#000 20px)",
          pointerEvents: "none",
        }}
      />
...
function ChalkboardPanel({
  ...
  return (
    ...
    >
      ...
      {activity.visual && <div className="chk-visual">{activity.visual}</div>}
        ...
        {actSelected && (
          <motion.div
            ...
            style={{
              ...
              background:
                "radial-gradient(ellipse at center top, rgba(82,183,136,0.18) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
        )}
...
export default function MathsCartoonLesson({
  ...
  function triggerDavidMsg(idx?: number) {
    ...
    setDavidMsgIdx(
      idx !== undefined
        ? idx
        : Math.floor(Math.random() * DAVID_MESSAGES.length),
    );
  ...
  const interactionDone = slide?.interactive
    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          style={{
            ...
            height: "26%",
            background:
              SCENE_GROUND[Math.min(storyPage, SCENE_GROUND.length - 1)],
        ...
        >
          ...
          >
            {[
              14, 38, 66, 94, 122, 150, 178, 206, 234, 262, 290, 318, 346, 374,
            ].map((x, i) => (
              <g key={i}>
                <path
                  d={`M${x},14 Q${x - 3},0 ${x + 2},6`}
                  stroke="#1a0800"
                  strokeWidth={3}
                  fill="none"
                  strokeLinecap="round"
      ...
      <div className="mcl-hud">
        ...
        <div className="student-bar" style={{ flexShrink: 0 }}>
          <div
            className="sbar-avatar"
            style={{ background: "#1a3a2a", borderColor: "#52B788" }}
          >
          ...
          <div className="sbar-stat">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
              ...
              />
              <path
                d="M12 8C12 8 9 12 9 14.5a3 3 0 006 0C15 12 12 8 12 8z"
                fill="#FFD93D"
              />
            </svg>
      ...
      <div className="mcl-characters">
          ...
          <>
            ...
            >
              {storyPage === 3 ? (
                ...
                >
                  ...
                  {/* Trunk shadow blob */}
                  <path
                    d="M 60,152 Q 56,104 58,74 Q 70,70 82,74 Q 84,104 76,152 Z"
                    fill="#3d1a06"
                  />
                  {/* Trunk main body */}
                  <path
                    d="M 50,152 Q 44,102 46,70 Q 60,64 84,70 Q 88,102 80,152 Z"
                    fill="#a06830"
                  />
                  {/* Trunk highlight strip */}
                  <path
                    d="M 50,152 Q 46,102 48,70 L 57,70 Q 55,102 56,152 Z"
                    fill="#c07840"
                    opacity={0.6}
                  />
                  {/* Trunk outline */}
                  <path
                    d="M 50,152 Q 44,102 46,70 Q 60,64 84,70 Q 88,102 80,152"
                    fill="none"
                    stroke="#1a0800"
                    strokeWidth={4}
                ...
                >
                  ...
                  {/* Trunk shadow blob */}
                  <path
                    d="M 56,157 Q 52,110 56,73 Q 62,69 78,73 Q 82,110 78,157 Z"
                    fill="#3d1a06"
                  />
                  {/* Trunk main */}
                  <path
                    d="M 53,157 Q 48,108 52,70 Q 58,65 74,70 Q 78,108 77,157 Z"
                    fill="#a06830"
                  />
                  {/* Trunk highlight */}
                  <path
                    d="M 53,157 Q 50,108 54,70 L 60,70 Q 57,108 58,157 Z"
                    fill="#c07840"
                    opacity={0.55}
                  />
                  {/* Bark ring marks */}
                  ...
                  {/* Trunk outline */}
                  <path
                    d="M 53,157 Q 48,108 52,70 Q 58,65 74,70 Q 78,108 77,157"
                    fill="none"
                    stroke="#1a0800"
                    strokeWidth={4}
                    strokeLinecap="round"
            ...
            {interactionStep < tapTarget && (
              <motion.div
                ...
                transition={{ duration: 1.2, repeat: Infinity }}
              >
                {lang === "tok" ? "Pres!" : "Tap!"} ({interactionStep}/
                {tapTarget})
              </motion.div>
            )}
            ...
            >
              <svg viewBox="0 0 72 72" width={160} height={160}>
                ...
                <path
                  d="M10,28 L18,64 L26,64 L18,28 Z"
                ...
                {/* Basket outline */}
                <path
                  d="M10,28 L18,64 L54,64 L62,28 Z"
                  fill="none"
                  stroke="#1a0800"
                  strokeWidth={3}
                  strokeLinejoin="round"
        ...
        {isTapAdd && addCombined && sessionMode === "story" && (
          ...
          >
            ...
            >
              {[...Array(slide?.tapCountA ?? 0)].map((_, i) => (
                <span key={`a${i}`} style={{ fontSize: 38 }}>
                  {slide?.tapGroupA}
                </span>
              ))}
              {[...Array(slide?.tapCountB ?? 0)].map((_, i) => (
                <span key={`b${i}`} style={{ fontSize: 38 }}>
                  {slide?.tapGroupB}
                </span>
              ))}
            </div>
      ...
      {companion && (
        <CompanionAssistant
          ...
          onHelpCount={
            activity?.visual ? () => setCountingActive(true) : undefined
          }
          overrideExpr={
            showIntro
              ? "excited"
